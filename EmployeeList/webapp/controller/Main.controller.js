...
sap.ui.define([
    ...
    return Controller.extend("logaligroup.EmployeeList.controller.Main", {
        ...
        showEmployeeDetails: function (category, nameEvent, path) {
            ...
            detailView.bindElement("odataNorthwind.svc>" + path);
            ...
            this.onReadODataIncidence(this._detailEmployeeView.getBindingContext("odataNorthwind.svc").getObject().EmployeeID);
        },
        ...
        onSaveODataIncidence: function (channelId, eventId, data) {
            ...
            var oResourceBundle = this.getView().getModel("i18n").getResourceBundle();
            var employeeId = this._detailEmployeeView.getBindingContext("odataNorthwind.svc").getObject().EmployeeID;
            ...
            this.getView().getModel("incidenceModel").read("/IncidentsSet", {
                ...
                success: function (data) {
                    ...
                    for (var incidence in data.results) {
                        ...
                        var newIncidence = sap.ui.xmlfragment("logaligroup.EmployeeList.fragment.NewIncidence", this._detailEmployeeView.getController())
